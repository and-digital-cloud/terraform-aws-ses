...
1. Reporting an issue or making a feature request [here](https://github.com/and-digital/terraform-aws-ses/issues).
...
1. Fork and *git clone* [the-reop](https://github.com/and-digital/terraform-aws-ses).
...
2. **Documentation**: Pull requests need to update the [documentation](https://github.com/and-digital/terraform-aws-ses/tree/master/README.md) together with the code change.
